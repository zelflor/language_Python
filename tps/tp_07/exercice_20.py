# Exercice 20 : Le programme ci-dessous demande à l'utilisateur de saisir le nom d'une commune d'Indre-et-Loire.
# Compléter ce programme pour qu'il affiche le nombre d'habitants de la commune saisie.
# Pour cela, le programme devra parcourir la liste des noms des communes jusqu'à trouver le nom de la commune saisie.
# Si la commune saisie n'existe pas, le programme devra afficher un message d'erreur.
