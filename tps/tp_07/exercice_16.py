# Exercice 16 : Compléter le programme suivant afin qu'il affiche le nombre d'habitants de la ville la plus peuplée d'Indre-et-Loire.
...
nbrhabitantsmax = 1
nbrhabitantsmaxindex = 0
for i in range(len(nbHabitants)) :   # i prend successivement toutes les valeurs des indices de la liste
    if nbHabitants[i] > nbrhabitantsmax:
        nbrhabitantsmax = nbHabitants[i]
        nbrhabitantsmaxindex = i


print(nbrhabitantsmax)
print(communes[nbrhabitantsmaxindex])