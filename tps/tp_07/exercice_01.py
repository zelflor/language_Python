# Exercice 1 : Les deux listes ci-dessous donnent respectivement le nombre d'habitants de chaque commune d'Indre-et-Loire en 2018 et le nom de chaque commune par ordre alphabétique (source : Wikipédia). Les deux listes ont la même taille et l'ordre est le même pour les deux listes.
# La première liste est une liste d'entiers.
# La deuxième liste est une liste de chaînes de caractères.

# Combien y a-t-il de communes en Indre-et-Loire?
